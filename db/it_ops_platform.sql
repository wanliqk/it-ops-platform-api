...
CREATE TABLE it_faq (
    id BIGINT PRIMARY KEY AUTO_INCREMENT COMMENT '常见问题ID，主键',
    title VARCHAR(200) NOT NULL COMMENT '问题标题',
    category VARCHAR(50) NOT NULL COMMENT '问题分类：computer电脑，network网络，printer打印机，account账号系统，other其他',
    summary VARCHAR(255) DEFAULT NULL COMMENT '问题摘要',
